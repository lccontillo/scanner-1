import { usePreviewStore } from "@/stores/editor-store.js";
...
export function adjustCanvas() {
  ...
  const saturate = (context, mix) => {
    let imageX = 0;
    let imageY = 0;
    let imageW = context.canvas.width;
    let imageH = context.canvas.height;
  ...
  return { sharpen, saturate, brighten, contrast };
}
